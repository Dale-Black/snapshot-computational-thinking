...
#> tags = ["lecture", "module2", "track_data", "optimization", "interactive"]
#> layout = "layout.jlhtml"
#> description = "Gradient descent rolls a ball downhill to find the minimum of a function. Set the starting point, the learning rate and the number of steps, and watch it converge — or overshoot and diverge — live in your browser as WebAssembly."
#> license = "MIT"
...
# ╔═╡ c4a00002-0000-4000-8000-000000000002
begin
...
Almost every machine-learning model is *trained* by **minimizing** a function — the
"loss" that measures how wrong the model is. The workhorse algorithm for doing that is
**gradient descent**, and the idea is beautifully simple:

> Stand on a hillside in the fog. Feel which way is downhill (the *gradient*). Take a
> small step that way. Repeat.

The "small step" size is the **learning rate**. Too small and you crawl; too big and you
leap right over the valley and bounce out. Below you can set the starting point and the
