...
#> tags = ["lecture", "module1", "image", "convolution", "filtering", "interactive"]
#> license = "Unlicense"
#> license_url = "https://github.com/JuliaPluto/featured/blob/2a6a9664e5428b37abe4957c1dca0994f4a8b7fd/LICENSES/Unlicense"
#> description = "Images are arrays of numbers; a filter (kernel) convolved over them blurs, sharpens, and finds edges — live in your browser via WebAssembly."
#> date = "2023-07-09"
#>
#>     [[frontmatter.author]]
#>     name = "Boshra Ariguib"
...
md"""
*Module 1 · §4 — the image-filtering core of MIT Computational Thinking's "Transformations
with Images" lecture, here as a self-contained WebAssembly island. Adapted from Boshra
Ariguib's [**Images and Filtering**](https://featured.plutojl.org) Pluto featured notebook.*
